  ...
  return `
    <div class="consumer-shell">
      ...
      <section class="featured-hero">
        <div class="fh-photo"><img src="img/featured-chef.jpg" alt="${esc(featured.name)} chef" /></div>
        <div class="fh-body">
          <div class="fh-tag">Featured restaurant · meet the chef</div>
...
function renderPartners() {
  ...
  return `
    <div class="partner-shell">
      ...
      <section class="p-cta admin-cta"><div class="p-cta-left"><div class="p-label">Admin control</div>
        <div class="p-cta-t">Manage your modules</div>
        <div class="p-cta-d">Enable or disable the search bar, featured hero, dish of the day, chef story, what Toronto ate, gives, gallery, auctions, fleet, payouts &amp; kitchens.</div></div>
        <a href="#admin" class="btn p-primary">${ico("gear")} Open Admin Modules ${ico("arrow")}</a></section>
